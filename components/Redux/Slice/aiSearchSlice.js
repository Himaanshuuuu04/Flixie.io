...
const API_KEY = process.env.NEXT_PUBLIC_GEMINI_API_KEY; // Ensure your API key is set in the environment
const initialState = {
...
export const fetchAiRecommendations = createAsyncThunk(
  ...
  async (query, { rejectWithValue, dispatch }) => {
    const schema = {
      description:
        "List of at least 5 or more recommendations of movies or series related to description or keywords",
      type: "array",
      items: {
        type: "object",
        properties: {
