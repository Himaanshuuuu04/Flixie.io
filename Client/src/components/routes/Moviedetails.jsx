  ...
  return (
    <BackgroundGradientAnimation>
      <div className="min-h-screen flex flex-col items-center justify-center overflow-y-auto">
        ...
        <button
          onClick={() => navigate(-1)}
          className="absolute top-6 left-4 flex items-center bg-white/10 border border-white/20 text-white font-medium py-2 px-4 rounded-2xl shadow-sm transition-transform transform hover:scale-105 hover:bg-blue-500 focus:outline-none duration-200 ease-in-out"
        >
          <svg
            className="w-4 h-4 mr-1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="text-sm -mb-1">Go Back</span>
        </button>
      </div>
    </BackgroundGradientAnimation>
  );
