...
const Moviedetails = () => {
  ...
  return (
    <BackgroundGradientAnimation>
      <div className="bg-white/10 backdrop-blur-3xl border-2 border-white/20 h-full md:h-[90vh] m-10 flex flex-col md:flex-row rounded-2xl relative overflow-hidden">
        {/* Left Column */}
        ...
        <div className="flex flex-col p-4 md:p-8 gap-6 w-full md:w-1/2 overflow-y-auto">
          <h1 className="text-3xl md:text-4xl  font-bold text-white">
            ...
            <div className="flex gap-4 -mt-2">
                ...
                >
                    ...
                    <span className="text-sm -mb-1">Like</span>
                </a>
                </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-1">
              <h2 className="text-white text-base  font-bold">Reviews:</h2>
              {movieDetails.reviews.results.slice(0, 3).map((review) => (
                <div key={review.id} className="text-white text-sm font-thin">
                  <strong>{review.author}:</strong> {review.content.slice(0,100)}...
                </div>
              ))}
            </div>
          )}
