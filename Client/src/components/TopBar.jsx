    ...
    return (
        <div className="flex flex-row flex-grow space-x-10 mt-10 w-[100%] mr-10  ml-[21rem] font-sans font-light text-white text-lg z-50">
            ...
            <div className="relative flex flex-col items-center z-50 transition-all duration-200 transform hover:scale-105">
                ...
                {isOpen && (
                    <div
                        className="absolute mt-[3.5rem] w-48 border border-slate-800 rounded-xl backdrop-filter backdrop-blur-3xl shadow-lg  text-white z-50 text-center
            ...
            {/* Search Input */}
            <div className="flex justify-center items-center w-[40%]  p-2 border-2 border-slate-800 rounded-2xl backdrop-filter backdrop-blur-3xl shadow-xl text-white z-50 hover:border-blue-400 hover:scale-105 transition-all duration-200 ">
                <input
                    type="text"
                    placeholder="Search"
            ...
            {/* Profile Button */}
            <button className="transition-transform duration-200 transform hover:scale-105 z-50 ">
                <div className="flex justify-center items-center p-2 border-2 border-slate-800 rounded-full backdrop-filter backdrop-blur-3xl shadow-xl text-white hover:bg-blue-400 transition-colors duration-200 z-50">
