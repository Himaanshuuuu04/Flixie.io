...
import { setProfileCompleted } from "../Redux/Slice/authSlice";
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      await databases.createDocument(
        ...
        process.env.NEXT_PUBLIC_APPWRITE_COLLECTION_USERS_ID, // Collection ID
      ...
      toast.success(
        "Profile completed successfully! Redirecting to the Home page...",
        {
          position: "top-right",
          autoClose: 3000,
        },
